...
function renderReport(serverResult){
 ...
 <div class="solution-cta"><div><h3>See how these issues can be systemized</h3><p>Based on your ${c[0]} result and ${intent} timeline, explore capabilities relevant to your current priorities.</p></div><button class="primary-btn" onclick="window.location.href='https://classlift.ca'">See how a system can solve my top issues <span>→</span></button></div></div></article>`;
}
